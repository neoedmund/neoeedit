...
public class ScriptUtil {
    ...
    public void runSingleScript(PlainPage ppTarget, String script, List<CharSequence> input) throws Exception {
        // 3.1.
        ...
        PlainPage p2 = PlainPage.getPP(ppTarget.uiComp, PageData.newEmpty(String.format("%s#%s", hint, U.randomID())));
