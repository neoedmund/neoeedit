...
public class ScriptUtil {
  ...
  public void runSingleScript(PlainPage ppTarget, String script,
    ...
    String javac =
        javaPath + (FindJDK.isWindows ? "/bin/javac.exe" : "/bin/javac");
    ...
    PlainPage p2 = PlainPage.getPP(
        ppTarget.uiComp,
        PageData.newEmpty(String.format("%s#%s", hint, U.randomID())));
    p2.pageData.setLines(ret);
    ppTarget.uiComp.repaint();
    ppTarget.uiComp.grabFocus();
  }
  ...
  class Exec {
    ...
    public void addArg(String s) { sb.add(s); }
