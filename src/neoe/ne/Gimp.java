...
/**
 * bad performance and effects, should done in GPU someday
 */
@ Deprecated
public class Gimp {
	...
	public static void loadFromConfig ( ) throws IOException {
		center_weight = U . getFloat ( Conf . get ( "glow.center" , 100f ) ) ;
		range = U . getInt ( Conf . get ( "glow.range" , 3 ) ) ;
		glowDisabled = U . getBool ( Conf . get ( "glow.disabled" , false ) ) ;
		System . out . println ( "glowDisabled=" + glowDisabled + ","
			+ Conf . get ( Conf . getConfig ( ) , "glow.disabled" ) ) ;
		glow_threshold = U . getFloat ( Conf . get ( "glow.threshold" , 0 ) ) ;
	}
