...
public class Main {
  ...
  //	public static EditorPanel open(String title, String text) throws
  //Exception { 		EditorPanel editor = new EditorPanel(EditorPanelConfig.DEFAULT);
  //		PlainPage pp = new PlainPage(editor, PageData.newEmpty(title,
  //"")); 		pp.ptEdit.append(text); 		editor.openWindow(); 		return editor;
  //	}
