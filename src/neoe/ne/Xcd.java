...
public class Xcd {
	...
	private void readFromNeoeeditHistory(Set<String> uniq, String key) throws IOException {
		// ~/.neoeedit/dh.txt
	...
	private void readFromBashHistory(Set<String> uniq, String key) throws IOException {
