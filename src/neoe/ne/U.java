...
public class U {
	...
	public static List<CharSequence> getPageListStrings(EditPanel ep)
			throws IOException {
	...
	public static boolean gotoFileLinePos(EditPanel ep, String fn, int line,
	...
	static boolean openFile(String title, int line, EditPanel ep, boolean recCh)
			throws Exception {
	...
	private static void saveDirHistory(String fn) throws IOException {
		...
		String old = FileUtil.readString(new FileInputStream(
	...
	static List<Str> split(String s, char sep) {
